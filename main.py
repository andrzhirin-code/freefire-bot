...
def handle_message(user_id, text, ref=None):
    ...
    if t == "💣 Лучшие позиции":
        send_message(user_id,
            ...
            "▸ Башня на острове — защищённая позиция для снайпера\n"
            "▸ Домики на побережье — мало кто проверяет\n\n"
            "Калахари:\n"
            "▸ Скалы у центра — обзор всей карты\n"
            "▸ Заброшенные здания — много лута и укрытий\n"
            "▸ Под мостом — неожиданная позиция для засады\n\n"
            "Альпака:\n"
            "▸ Крыши высоких зданий — контроль улиц\n"
            "▸ Железная дорога — длинная линия обзора\n"
            "▸ Туннель — скрытое перемещение\n\n"
